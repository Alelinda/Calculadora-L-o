  ...
  return(
    <div className="calculadora-container">
      ...
      <div className="calculadora-botoes">
        ...
        <button className="calculadora-botao calculadora-botao-0"
         onClick={() => handleButtonClick('0')}>0</button>

        <button className="calculadora-botao calculadora-botao-clear"
         onClick={() => handleClear('C')}>C</button>

        <button className="calculadora-botao calculadora-botao-igual"
